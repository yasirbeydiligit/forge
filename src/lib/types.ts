...
export type MuscleFunction = Tables<"muscle_functions">;
export type ExerciseMuscleTarget = Tables<"exercise_muscle_targets">;
...
export type TrackerSettings = Tables<"tracker_settings">;
